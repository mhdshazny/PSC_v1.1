    ...
    <div class="col-md-10 d-none d-md-block container" style="">
        ...
        <div class="container-fluid rounded mb-5" style="min-height: 100%; background-color: #04333b" >
            ...
            <div class="container-fluid mb-lg-5">
                <br>
                <p class="text-white font-weight-bold" style="font-size: 250%; margin-left: 10%">Cash Allocation Reports</p>
            </div>
            ...
            <div class="row" style="margin-left: 0%">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <form action="cashAllocationReportPDF.php" method="post">
            ...
            <div class="row">
                <div class="container-fluid ">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
                        <table id="cashTable" class="table table-bordered table-hover table-light">
                            <thead>
                            <tr>
                                <th>Transfer ID</th>
                            ...
                            <?php
                            include("../../Common/config.php");
                            $loadTable = "SELECT * FROM `tbl_mnytransfers` ORDER BY `dateOn` DESC ";
