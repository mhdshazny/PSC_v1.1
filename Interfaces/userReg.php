...
<div class="container-fluid bg-light" style="width: 100%">
    ...
    <div class="container-fluid" style=" min-height:230px; width: 100%; left: 20%">
        <br>
        <p class="text-info font-weight-bold" style="font-size: 250%; margin-left: 20%">User Registration</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="file" id="firstName" placeholder="First Name" class="form-control" autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="container" style="margin-left: 30%">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" style="width: 50%; align-content: center">Register</button>
                </div>
