...
<div class="row">
    ...
    <div class="container-fluid" style=" min-height:230px; width: 100%">
        <br>
        <p class="text-info font-weight-bold" style="font-size: 250%"> Hello Collection officer!</p>
    </div>
    ...
    <div class="container-fluid" style="min-height: 550px; width:1700px">
        ...
        <div class="container">
            ...
            <a href="setPurchaseOrder_dB.php" class="btn btn-warning btn-lg btnMenu mx-2" role="button"><span class="glyphicon glyphicon-bookmark"></span> <br/>New Purchase Order</a>
